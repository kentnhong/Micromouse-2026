...
#include "stm32f4xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            PLLP; /*!< PLLP: Division factor for main system clock (SYSCLK).
                            This parameter must be a value of @ref RCC_PLLP_Clock_Divider             */

        uint32_t
            PLLQ; /*!< PLLQ: Division factor for OTG FS, SDIO and RNG clocks.
  ...
  */
    ...
    {
        uint32_t
            PLLI2SM; /*!< Specifies division factor for PLL VCO input clock.
  ...
  */
    ...
    {
        uint32_t
            PLLSAIM; /*!< Specifies division factor for PLL VCO input clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 63       */
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            PLLI2SDivQ; /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLI2S is selected as Clock Source SAI */

        uint32_t
            PLLSAIDivQ; /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLSAI is selected as Clock Source SAI */

        uint32_t
            Sai1ClockSelection; /*!< Specifies SAI1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SAI1_Clock_Source */

        uint32_t
            Sai2ClockSelection; /*!< Specifies SAI2 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SAI2_Clock_Source */

        uint32_t
            I2sApb1ClockSelection; /*!< Specifies I2S APB1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_I2SAPB1_Clock_Source */

        uint32_t
            I2sApb2ClockSelection; /*!< Specifies I2S APB2 Clock Source Selection.
        ...
        uint32_t
            SdioClockSelection; /*!< Specifies SDIO Clock Source Selection.
        ...
        uint32_t
            Fmpi2c1ClockSelection; /*!< Specifies FMPI2C1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_FMPI2C1_Clock_Source */

        uint32_t
            SpdifClockSelection; /*!< Specifies SPDIFRX Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SPDIFRX_Clock_Source */

        uint32_t
            Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this clock used OTG FS, SDIO and RNG clocks.
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            Lptim1ClockSelection; /*!< Specifies LPTIM1 Clock Source Selection.
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            PLLDivR; /*!< Specifies the PLL division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLL is selected as Clock Source SAI */

        uint32_t
            PLLI2SDivR; /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLI2S is selected as Clock Source SAI */
        ...
        uint32_t
            Dfsdm1AudioClockSelection; /*!< Specifies DFSDM1 Audio Clock Selection.
        ...
        uint32_t
            Dfsdm2AudioClockSelection; /*!< Specifies DFSDM2 Audio Clock Selection.
        ...
        uint32_t
            SaiAClockSelection; /*!< Specifies SAI1_A Clock Prescalers Selection
                                        This parameter can be a value of @ref RCCEx_SAI1_BlockA_Clock_Source */

        uint32_t
            SaiBClockSelection; /*!< Specifies SAI1_B Clock Prescalers Selection
                                        This parameter can be a value of @ref RCCEx_SAI1_BlockB_Clock_Source */
#endif                          /* STM32F413xx || STM32F423xx */

        uint32_t
            PLLI2SSelection; /*!< Specifies PLL I2S Clock Source Selection.
  ...
  */
    typedef struct
    {
        ...
        uint32_t
            PLLSAIDivR; /*!< Specifies the PLLSAI division factor for LTDC clock.
                                      This parameter must be one value of @ref RCCEx_PLLSAI_DIVR */

        uint32_t
            RTCClockSelection; /*!< Specifies RTC Clock Prescalers Selection.
                                      This parameter can be a value of @ref RCC_RTC_Clock_Source */

        uint8_t
            TIMPresSelection; /*!< Specifies TIM Clock Prescalers Selection.
                                      This parameter can be a value of @ref RCCEx_TIM_PRescaler_Selection */
#if defined(STM32F469xx) || defined(STM32F479xx)
        uint32_t
            Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this clock used OTG FS, SDIO and RNG clocks.
    ...
    defined(STM32F417xx) || defined(STM32F401xC) || defined(STM32F401xE) || \
    defined(STM32F411xE)
    /**
  * @brief  PLLI2S Clock structure definition
  */
    typedef struct
    {
        ...
        uint32_t
            PLLI2SM; /*!< PLLM: Division factor for PLLI2S VCO input clock.
...
/**
  ...
  */
    ...
    defined(STM32F401xE) || defined(STM32F411xE) || defined(STM32F469xx) || \
    defined(STM32F479xx)
...
#define RCC_SAIACLKSOURCE_PLLSRC \
    ((uint32_t)RCC_DCKCFGR_SAI1ASRC_0 | RCC_DCKCFGR_SAI1ASRC_1)
/**
  * @}
  */
...
#define RCC_SAIBCLKSOURCE_PLLSRC \
    ((uint32_t)RCC_DCKCFGR_SAI1BSRC_0 | RCC_DCKCFGR_SAI1BSRC_1)
/**
  * @}
  */
...
#define RCC_LPTIM1CLKSOURCE_LSE \
    ((uint32_t)RCC_DCKCFGR2_LPTIM1SEL_0 | RCC_DCKCFGR2_LPTIM1SEL_1)
/**
  * @}
  */
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) || \
    defined(STM32F439xx) || defined(STM32F401xC) || defined(STM32F401xE) || \
    defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx) || \
    defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F469xx) || \
...
#define __HAL_RCC_ETHMACTX_IS_CLK_ENABLED() \
    ((RCC->AHB1ENR & (RCC_AHB1ENR_ETHMACTXEN)) != RESET)
...
#define __HAL_RCC_SDIO_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_SDIOEN)) != RESET)
...
#define __HAL_RCC_DSI_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_DSIEN)) != RESET)
...
#define __HAL_RCC_ETHMACTX_CLK_SLEEP_ENABLE() \
    (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETHMACTXLPEN))
#define __HAL_RCC_ETHMACRX_CLK_SLEEP_ENABLE() \
    (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETHMACRXLPEN))
#define __HAL_RCC_ETHMACPTP_CLK_SLEEP_ENABLE() \
    (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETHMACPTPLPEN))
...
#define __HAL_RCC_FSMC_IS_CLK_ENABLED() \
    ((RCC->AHB3ENR & (RCC_AHB3ENR_FSMCEN)) != RESET)
...
#define __HAL_RCC_CRC_IS_CLK_ENABLED() \
    ((RCC->AHB1ENR & (RCC_AHB1ENR_CRCEN)) != RESET)
#define __HAL_RCC_RNG_IS_CLK_ENABLED() \
    ((RCC->AHB1ENR & (RCC_AHB1ENR_RNGEN)) != RESET)
...
#define __HAL_RCC_EXTIT_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_EXTITEN)) != RESET)
...
#if defined(STM32F412Vx) || defined(STM32F412Zx) || defined(STM32F413xx) || \
    defined(STM32F423xx)
#define __HAL_RCC_GPIOE_CLK_ENABLE()                          \
    do                                                        \
    {                                                         \
...
#define __HAL_RCC_CAN3_IS_CLK_ENABLED() \
    ((RCC->APB1ENR & (RCC_APB1ENR_CAN3EN)) != RESET)
#define __HAL_RCC_DAC_IS_CLK_ENABLED() \
    ((RCC->APB1ENR & (RCC_APB1ENR_DACEN)) != RESET)
#define __HAL_RCC_UART7_IS_CLK_ENABLED() \
    ((RCC->APB1ENR & (RCC_APB1ENR_UART7EN)) != RESET)
...
#define __HAL_RCC_UART9_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_UART9EN)) != RESET)
#define __HAL_RCC_UART10_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_UART10EN)) != RESET)
#endif /* STM32F413xx || STM32F423xx */
#define __HAL_RCC_SDIO_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_SDIOEN)) != RESET)
#define __HAL_RCC_SPI4_IS_CLK_ENABLED() \
...
#define __HAL_RCC_DFSDM1_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_DFSDM1EN)) != RESET)
#if defined(STM32F413xx) || defined(STM32F423xx)
#define __HAL_RCC_DFSDM2_IS_CLK_ENABLED() \
    ((RCC->APB2ENR & (RCC_APB2ENR_DFSDM2EN)) != RESET)
#endif /* STM32F413xx || STM32F423xx */
...
#define __HAL_RCC_AES_CLK_SLEEP_ENABLE() \
    (RCC->AHB2LPENR |= (RCC_AHB2LPENR_AESLPEN))
...
/** @brief  Macro to configure the main PLL clock source, multiplication and division factors.
  ...
  *
  */
#define __HAL_RCC_PLL_CONFIG(__RCC_PLLSource__, __PLLM__, __PLLN__, __PLLP__, \
                             __PLLQ__, __PLLR__)                              \
...
/** @brief  Macro to configure the PLLI2S clock multiplication and division factors .
  ...
  *         This parameter must be a number between Min_Data = 2 and Max_Data = 15.
  */
#define __HAL_RCC_PLLI2S_CONFIG(__PLLI2SM__, __PLLI2SN__, __PLLI2SP__,    \
                                __PLLI2SQ__, __PLLI2SR__)                 \
    (RCC->PLLI2SCFGR =                                                    \
...
#elif defined(STM32F412Zx) || defined(STM32F412Vx) || defined(STM32F412Rx) || \
    defined(STM32F412Cx) || defined(STM32F413xx) || defined(STM32F423xx)
/** @brief  Macro to configure the PLLI2S clock multiplication and division factors .
  * @note   This macro must be used only when the PLLI2S is disabled.
  * @note   PLLI2S clock source is common with the main PLL (configured in
  ...
  *         This parameter must be a number between Min_Data = 2 and Max_Data = 15.
  */
#define __HAL_RCC_PLLI2S_CONFIG(__PLLI2SM__, __PLLI2SN__, __PLLI2SQ__,    \
                                __PLLI2SR__)                              \
    (RCC->PLLI2SCFGR =                                                    \
         ((__PLLI2SM__) | ((__PLLI2SN__) << RCC_PLLI2SCFGR_PLLI2SN_Pos) | \
          ((__PLLI2SQ__) << RCC_PLLI2SCFGR_PLLI2SQ_Pos) |                 \
...
#define __HAL_RCC_PLLI2S_SAICLK_CONFIG(__PLLI2SN__, __PLLI2SQ__, __PLLI2SR__) \
    (RCC->PLLI2SCFGR = ((__PLLI2SN__) << 6U) | ((__PLLI2SQ__) << 24U) |       \
                       ((__PLLI2SR__) << 28U))
#endif /* STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx || STM32F469xx || STM32F479xx */
/*----------------------------------------------------------------------------*/
...
/** @brief  Macro to configure the PLLSAI clock multiplication and division factors.
  ...
  */
#define __HAL_RCC_PLLSAI_CONFIG(__PLLSAIM__, __PLLSAIN__, __PLLSAIP__,    \
                                __PLLSAIQ__, __PLLSAIR__)                 \
    (RCC->PLLSAICFGR =                                                    \
...
#define __HAL_RCC_GET_I2S_SOURCE() \
    ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_I2SSRC)))
...
/** @brief  Macro to configure SAI1BlockA clock source selection.
  ...
  */
#define __HAL_RCC_SAI_BLOCKACLKSOURCE_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_SAI1ASRC, (__SOURCE__)))
...
/** @brief  Macro to configure the CLK48 clock.
  ...
  */
#define __HAL_RCC_CLK48_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CK48MSEL, (uint32_t)(__SOURCE__)))
...
/** @brief  Macro to Get the CLK48 clock.
  ...
  */
#define __HAL_RCC_GET_CLK48_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CK48MSEL))
...
/** @brief  Macro to configure the SDIO clock.
  ...
  */
#define __HAL_RCC_SDIO_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_SDIOSEL, (uint32_t)(__SOURCE__)))
...
/** @brief  Macro to Get the SDIO clock.
  ...
  */
#define __HAL_RCC_GET_SDIO_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_SDIOSEL))
...
/** @brief  Macro to configure the DSI clock.
  ...
  */
#define __HAL_RCC_DSI_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_DSISEL, (uint32_t)(__SOURCE__)))
...
#define __HAL_RCC_DFSDM1_CONFIG(__DFSDM1_CLKSOURCE__) \
    MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL, (__DFSDM1_CLKSOURCE__))
...
#define __HAL_RCC_GET_DFSDM1_SOURCE() \
    ((uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL)))
...
/** @brief  Macro to configure DFSDM1 Audio clock source selection.
  ...
  */
#define __HAL_RCC_DFSDM1AUDIO_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1ASEL, (__SOURCE__)))
...
#define __HAL_RCC_GET_DFSDM1AUDIO_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1ASEL))
...
/** @brief  Macro to configure the DFSDM2 clock.
  ...
  * @retval None
 */
#define __HAL_RCC_DFSDM2_CONFIG(__DFSDM2_CLKSOURCE__) \
    MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL, (__DFSDM2_CLKSOURCE__))
...
/** @brief  Macro to configure DFSDM1 Audio clock source selection.
  ...
  */
#define __HAL_RCC_DFSDM2AUDIO_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM2ASEL, (__SOURCE__)))
...
#define __HAL_RCC_GET_DFSDM2AUDIO_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM2ASEL))
...
#define __HAL_RCC_GET_SAI_BLOCKA_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_SAI1ASRC))
...
#define __HAL_RCC_GET_SAI_BLOCKB_SOURCE() \
    (READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_SAI1BSRC))
...
/** @brief  Macro to configure the LPTIM1 clock.
  ...
  */
#define __HAL_RCC_LPTIM1_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_LPTIM1SEL, (uint32_t)(__SOURCE__)))
...
#define __HAL_RCC_GET_LPTIM1_SOURCE() \
    (READ_BIT(RCC->DCKCFGR2, RCC_DCKCFGR2_LPTIM1SEL))
#endif /* STM32F413xx || STM32F423xx */
...
/** @brief  Macro to configure the PLL I2S clock source (PLLI2SCLK).
  ...
  *                                       used as I2S clock source.
  */
#define __HAL_RCC_PLL_I2S_CONFIG(__SOURCE__) \
    (*(__IO uint32_t*)RCC_PLLI2SCFGR_PLLI2SSRC_BB = (__SOURCE__))
...
/** @brief  Macro to configure I2S clock source selection.
  ...
  */
#define __HAL_RCC_I2S_CONFIG(__SOURCE__) \
    (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_I2SSRC, (__SOURCE__)))
...
#define RCC_CR_PLLSAION_BB \
    (PERIPH_BB_BASE + (RCC_CR_OFFSET * 32U) + (RCC_PLLSAION_BIT_NUMBER * 4U))
...
#define RCC_CR_PLLI2SON_BB \
    (PERIPH_BB_BASE + (RCC_CR_OFFSET * 32U) + (RCC_PLLI2SON_BIT_NUMBER * 4U))
#endif /* STM32F405xx || STM32F415xx || STM32F407xx || STM32F417xx || STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx ||
          STM32F401xC || STM32F401xE || STM32F411xE || STM32F446xx || STM32F469xx || STM32F479xx || STM32F412Zx || STM32F412Vx ||
...
/* --- DCKCFGR Register ---*/
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) || \
    defined(STM32F439xx) || defined(STM32F410Tx) || defined(STM32F410Cx) || \
    defined(STM32F410Rx) || defined(STM32F401xC) || defined(STM32F401xE) || \
    defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F469xx) || \
    defined(STM32F479xx) || defined(STM32F412Zx) || defined(STM32F412Vx) || \
    defined(STM32F412Rx) || defined(STM32F412Cx) || defined(STM32F413xx) || \
    defined(STM32F423xx)
...
#define RCC_CFGR_I2SSRC_BB \
    (PERIPH_BB_BASE + (RCC_CFGR_OFFSET * 32U) + (RCC_I2SSRC_BIT_NUMBER * 4U))
...
#define RCC_PLLI2SCFGR_PLLI2SSRC_BB                   \
    (PERIPH_BB_BASE + (RCC_PLLI2SCFGR_OFFSET * 32U) + \
     (RCC_PLLI2SSRC_BIT_NUMBER * 4U))
...
#define RCC_CFGR_MCO1EN_BB \
    (PERIPH_BB_BASE + (RCC_CFGR_OFFSET * 32U) + (RCC_MCO1EN_BIT_NUMBER * 4U))

/* Alias word address of MCO2EN bit */
#define RCC_MCO2EN_BIT_NUMBER 0x9U
#define RCC_CFGR_MCO2EN_BB \
    (PERIPH_BB_BASE + (RCC_CFGR_OFFSET * 32U) + (RCC_MCO2EN_BIT_NUMBER * 4U))
#endif /* STM32F410Tx || STM32F410Cx || STM32F410Rx */
...
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x0000007FU))
#endif /* STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx */

#if defined(STM32F405xx) || defined(STM32F415xx) || defined(STM32F407xx) || \
    defined(STM32F417xx)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x00000007U))
#endif /* STM32F405xx || STM32F415xx || STM32F407xx || STM32F417xx */

#if defined(STM32F401xC) || defined(STM32F401xE) || defined(STM32F411xE)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x0000000FU))
#endif /* STM32F401xC || STM32F401xE || STM32F411xE */

#if defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x0000001FU))
#endif /* STM32F410Tx || STM32F410Cx || STM32F410Rx */
...
#if defined(STM32F469xx) || defined(STM32F479xx)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x000001FFU))
#endif /* STM32F469xx || STM32F479xx */

#if defined(STM32F412Zx) || defined(STM32F412Vx) || defined(STM32F412Rx) || \
    defined(STM32F412Cx)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x000003FFU))
#endif /* STM32F412Zx || STM32F412Vx || STM32F412Rx || STM32F412Cx */

#if defined(STM32F413xx) || defined(STM32F423xx)
#define IS_RCC_PERIPHCLOCK(SELECTION) \
    ((1U <= (SELECTION)) && ((SELECTION) <= 0x00007FFFU))
#endif /* STM32F413xx || STM32F423xx */
...
#if defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F412Zx) || \
    defined(STM32F412Vx) || defined(STM32F412Rx) || defined(STM32F412Cx) || \
    defined(STM32F413xx) || defined(STM32F423xx)
...
#define IS_RCC_PLLI2SP_VALUE(VALUE)                                    \
    (((VALUE) == RCC_PLLI2SP_DIV2) || ((VALUE) == RCC_PLLI2SP_DIV4) || \
...
#define IS_RCC_PLLSAIP_VALUE(VALUE)                                    \
    (((VALUE) == RCC_PLLSAIP_DIV2) || ((VALUE) == RCC_PLLSAIP_DIV4) || \
     ((VALUE) == RCC_PLLSAIP_DIV6) || ((VALUE) == RCC_PLLSAIP_DIV8))
